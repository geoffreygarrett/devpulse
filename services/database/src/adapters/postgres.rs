...
//             created_at: row.try_get::<chrono::DateTime<chrono::Utc>, _>("created_at")?.to_string()
//         })
//     }
// }
//
...
//
// #[async_trait]
// impl DataAccess<AccountModel, AccountCreate, AccountUpdate> for PgPool {
//     type Error = DataAccessError;
//     async fn create(&self, item: &AccountCreate) -> Result<AccountModel, Self::Error> {
//         sqlx::query_as::<Postgres, AccountModel>(
//             r#"
//             INSERT INTO accounts
//                 (uuid, given_name, email, hash, avatar_url)
//             VALUES
//                 ($1::uuid, $2, $3, $4, $5)
//             RETURNING
//                 id, uuid, given_name, email, hash, avatar_url, created_at
//             "#,
//         )
//         .bind(&item.uuid)
...
//     }
//
//     async fn read(&self, id: u64) -> Result<Option<AccountModel>, Self::Error> {
...
//     }
//
//     async fn update(&self, item: &AccountUpdate) -> Result<AccountModel, Self::Error> {
...
//     }
//
//     async fn list(&self) -> Result<Vec<AccountModel>, Self::Error> {
//         sqlx::query_as::<_, AccountModel>(
