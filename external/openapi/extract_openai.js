...
const inputFile = path.join(__dirname, 'api.openai.com.json'); // Adjust the path to your input file
const outputFile = path.join(__dirname, 'api.openai.com.extracted.json'); // Adjust the path to your output file
...
extractOperations(inputFile, outputFile, {}, cacheableOperations, '/', true).then(r => console.log('Done!'));
