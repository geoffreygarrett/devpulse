...
impl TranscriptionSegment {
    pub fn new(
        id: i32, seek: i32, start: f32, end: f32, text: String, tokens: Vec<i32>, temperature: f32,
        avg_logprob: f32, compression_ratio: f32, no_speech_prob: f32,
    ...
    pub fn builder() -> TranscriptionSegmentBuilder {
        TranscriptionSegmentBuilder::create_empty()
    }
}
