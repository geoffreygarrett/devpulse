...
pub struct CreateThreadRequestToolResources {
    ...
    pub code_interpreter: Option<Box<models::CreateThreadRequestToolResourcesCodeInterpreter>>,
    #[serde(
        rename = "file_search",
        default,
...
impl CreateThreadRequestToolResources {
    ...
    pub fn builder() -> CreateThreadRequestToolResourcesBuilder {
        CreateThreadRequestToolResourcesBuilder::create_empty()
    }
}
