...
pub struct OrganizationFull {
    ...
    /// **Deprecated.** Please use [code security configurations](https://docs.github.com/rest/code-security/configurations) instead.  Whether GitHub Advanced Security is enabled for new repositories and repositories transferred to this organization.  This field is only visible to organization owners or mem
    #[serde(
        rename = "advanced_security_enabled_for_new_repositories",
        skip_serializing_if = "Option::is_none"
    )]
    pub advanced_security_enabled_for_new_repositories: Option<bool>,
    /// **Deprecated.** Please use [code security configurations](https://docs.github.com/rest/code-security/configurations) instead.  Whether Dependabot alerts are automatically enabled for new repositories and repositories transferred to this organization.  This field is only visible to organization owner
    #[serde(
        rename = "dependabot_alerts_enabled_for_new_repositories",
        skip_serializing_if = "Option::is_none"
    )]
    pub dependabot_alerts_enabled_for_new_repositories: Option<bool>,
    /// **Deprecated.** Please use [code security configurations](https://docs.github.com/rest/code-security/configurations) instead.  Whether Dependabot security updates are automatically enabled for new repositories and repositories transferred to this organization.  This field is only visible to organiza
    #[serde(
    ...
    /// **Deprecated.** Please use [code security configurations](https://docs.github.com/rest/code-security/configurations) instead.  Whether dependency graph is automatically enabled for new repositories and repositories transferred to this organization.  This field is only visible to organization owners
    #[serde(
        rename = "dependency_graph_enabled_for_new_repositories",
        skip_serializing_if = "Option::is_none"
    )]
    pub dependency_graph_enabled_for_new_repositories: Option<bool>,
    /// **Deprecated.** Please use [code security configurations](https://docs.github.com/rest/code-security/configurations) instead.  Whether secret scanning is automatically enabled for new repositories and repositories transferred to this organization.  This field is only visible to organization owners o
    #[serde(
        rename = "secret_scanning_enabled_for_new_repositories",
        skip_serializing_if = "Option::is_none"
    )]
    pub secret_scanning_enabled_for_new_repositories: Option<bool>,
    /// **Deprecated.** Please use [code security configurations](https://docs.github.com/rest/code-security/configurations) instead.  Whether secret scanning push protection is automatically enabled for new repositories and repositories transferred to this organization.  This field is only visible to organ
    #[serde(
...
impl OrganizationFull {
    /// Organization Full
    pub fn new(
        login: String, id: i32, node_id: String, url: String, repos_url: String,
        events_url: String, hooks_url: String, issues_url: String, members_url: String,
        public_members_url: String, avatar_url: String, description: Option<String>,
        has_organization_projects: bool, has_repository_projects: bool, public_repos: i32,
        public_gists: i32, followers: i32, following: i32, html_url: String, r#type: String,
    ...
    pub fn builder() -> OrganizationFullBuilder {
        OrganizationFullBuilder::create_empty()
    }
}
