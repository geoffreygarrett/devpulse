...
impl NullableRepository {
    ...
    pub fn new(
        id: i64, node_id: String, name: String, full_name: String,
        license: Option<models::NullableLicenseSimple>, forks: i32, owner: models::SimpleUser,
        ...
        has_pages: bool, has_downloads: bool, archived: bool, disabled: bool,
        pushed_at: Option<String>, created_at: Option<String>, updated_at: Option<String>,
        open_issues: i32, watchers: i32,
    ) -> NullableRepository {
        NullableRepository {
            id,
            node_id,
    ...
    pub fn builder() -> NullableRepositoryBuilder {
        NullableRepositoryBuilder::create_empty()
    }
}
/// The default value for a squash merge commit title:  - `PR_TITLE` - default to the pull request's title. - `COMMIT_OR_PR_TITLE` - default to the commit's title (if only one commit) or the pull request's title (when more than one commit).
