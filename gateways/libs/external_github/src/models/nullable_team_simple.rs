...
impl NullableTeamSimple {
    ...
    pub fn new(
        id: i32, node_id: String, url: String, members_url: String, name: String,
        description: Option<String>, permission: String, html_url: String,
        repositories_url: String, slug: String,
    ) -> NullableTeamSimple {
        NullableTeamSimple {
            id,
            node_id,
    ...
    pub fn builder() -> NullableTeamSimpleBuilder {
        NullableTeamSimpleBuilder::create_empty()
    }
}
