...
pub struct NullableIntegration {
    ...
    pub permissions: models::NullableIntegrationPermissions,
...
impl NullableIntegration {
    ...
    pub fn new(
        id: i32, node_id: String, owner: Option<models::NullableSimpleUser>, name: String,
        description: Option<String>, external_url: String, html_url: String, created_at: String,
        updated_at: String, permissions: models::NullableIntegrationPermissions,
        events: Vec<String>,
    ) -> NullableIntegration {
        NullableIntegration {
            id,
    ...
    pub fn builder() -> NullableIntegrationBuilder {
        NullableIntegrationBuilder::create_empty()
    }
}
