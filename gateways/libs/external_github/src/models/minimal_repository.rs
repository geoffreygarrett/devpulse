...
impl MinimalRepository {
    ...
    pub fn new(
        ...
        git_refs_url: String, git_tags_url: String, issue_comment_url: String,
        ...
        notifications_url: String, pulls_url: String, releases_url: String, stargazers_url: String,
        statuses_url: String, subscribers_url: String, subscription_url: String, tags_url: String,
        teams_url: String, trees_url: String, hooks_url: String,
    ) -> MinimalRepository {
        MinimalRepository {
            id,
            node_id,
    ...
    pub fn builder() -> MinimalRepositoryBuilder {
        MinimalRepositoryBuilder::create_empty()
    }
}
