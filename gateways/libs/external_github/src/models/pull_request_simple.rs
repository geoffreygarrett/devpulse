...
impl PullRequestSimple {
    ...
    pub fn new(
        ...
        state: String, locked: bool, title: String, user: Option<models::NullableSimpleUser>,
        body: Option<String>, labels: Vec<models::PullRequestSimpleLabelsInner>,
        milestone: Option<models::NullableMilestone>, created_at: String, updated_at: String,
        closed_at: Option<String>, merged_at: Option<String>, merge_commit_sha: Option<String>,
        assignee: Option<models::NullableSimpleUser>, head: models::PullRequestSimpleHead,
        base: models::PullRequestSimpleHead, _links: models::PullRequestSimpleLinks,
    ...
    pub fn builder() -> PullRequestSimpleBuilder {
        PullRequestSimpleBuilder::create_empty()
    }
}
