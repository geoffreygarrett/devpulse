...
**tools** | [**Vec<models::CreateAssistantRequestToolsInner>**](CreateAssistantRequest_tools_inner.md) | A list of tool enabled on the assistant. There can be a maximum of 128 tools per assistant. Tools can be of types `code_interpreter`, `file_search`, or `function`.  | [default to []]
