...
impl FineTuningJob {
    ...
    pub fn new(
        ...
        fine_tuned_model: Option<String>, finished_at: Option<i32>,
        hyperparameters: models::FineTuningJobHyperparameters, model: String, object: Object,
        organization_id: String, result_files: Vec<String>, status: Status,
        trained_tokens: Option<i32>, training_file: String, validation_file: Option<String>,
        seed: i32,
    ) -> FineTuningJob {
        FineTuningJob {
            id,
    ...
    pub fn builder() -> FineTuningJobBuilder {
        FineTuningJobBuilder::create_empty()
    }
}
/// The object type, which is always \"fine_tuning.job\".
