...
pub struct RunObject {
    ...
    #[serde(rename = "tools")]
    pub tools: Vec<models::CreateAssistantRequestToolsInner>,
...
impl RunObject {
    ...
    pub fn new(
        id: String, object: Object, created_at: i32, thread_id: String, assistant_id: String,
        status: Status, required_action: Option<models::RunObjectRequiredAction>,
        last_error: Option<models::RunObjectLastError>, expires_at: Option<i32>,
        started_at: Option<i32>, cancelled_at: Option<i32>, failed_at: Option<i32>,
        completed_at: Option<i32>, incomplete_details: Option<models::RunObjectIncompleteDetails>,
        model: String, instructions: String, tools: Vec<models::CreateAssistantRequestToolsInner>,
        metadata: Option<serde_json::Value>, usage: Option<models::RunCompletionUsage>,
        max_prompt_tokens: Option<i32>, max_completion_tokens: Option<i32>,
        truncation_strategy: models::TruncationObject,
        tool_choice: models::AssistantsApiToolChoiceOption, parallel_tool_calls: bool,
        ...
        RunObject {
            ...
            assistant_id,
            status,
            required_action: if let Some(x) = required_action {
                Some(Box::new(x))
            } else {
                None
            },
            last_error: if let Some(x) = last_error {
                Some(Box::new(x))
            } else {
                None
            },
