...
impl ListFineTuningJobCheckpointsResponse {
    pub fn new(
        data: Vec<models::FineTuningJobCheckpoint>, object: Object, has_more: bool,
    ...
    pub fn builder() -> ListFineTuningJobCheckpointsResponseBuilder {
        ListFineTuningJobCheckpointsResponseBuilder::create_empty()
    }
}
///
