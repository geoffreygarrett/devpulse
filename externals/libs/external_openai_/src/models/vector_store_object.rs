...
impl VectorStoreObject {
    ...
    pub fn new(
        id: String, object: Object, created_at: i32, name: String, usage_bytes: i32,
        file_counts: models::VectorStoreObjectFileCounts, status: Status,
        last_active_at: Option<i32>, metadata: Option<serde_json::Value>,
    ) -> VectorStoreObject {
        VectorStoreObject {
            id,
            object,
    ...
    pub fn builder() -> VectorStoreObjectBuilder {
        VectorStoreObjectBuilder::create_empty()
    }
}
/// The object type, which is always `vector_store`.
