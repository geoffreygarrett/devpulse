...
pub struct PrivateUser {
    ...
    pub plan: Option<Box<models::PrivateUserPlan>>,
    #[serde(
        rename = "suspended_at",
        default,
        with = "::serde_with::rust::double_option",
...
impl PrivateUser {
    ...
    pub fn new(
        ...
        received_events_url: String, r#type: String, site_admin: bool, name: Option<String>,
        company: Option<String>, blog: Option<String>, location: Option<String>,
        email: Option<String>, hireable: Option<bool>, bio: Option<String>, public_repos: i32,
        public_gists: i32, followers: i32, following: i32, created_at: String, updated_at: String,
        private_gists: i32, total_private_repos: i32, owned_private_repos: i32, disk_usage: i32,
        collaborators: i32, two_factor_authentication: bool,
    ) -> PrivateUser {
        PrivateUser {
            login,
            id,
    ...
    pub fn builder() -> PrivateUserBuilder {
        PrivateUserBuilder::create_empty()
    }
}
