...
impl CheckRun {
    ...
    pub fn new(
        id: i32, head_sha: String, node_id: String, external_id: Option<String>, url: String,
        html_url: Option<String>, details_url: Option<String>, status: Status,
        conclusion: Option<Conclusion>, started_at: Option<String>, completed_at: Option<String>,
        output: models::CheckRunOutput, name: String,
        check_suite: Option<models::CheckRunCheckSuite>, app: Option<models::NullableIntegration>,
