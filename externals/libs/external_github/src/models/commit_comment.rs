...
impl CommitComment {
    /// Commit Comment
    pub fn new(
        html_url: String, url: String, id: i32, node_id: String, body: String,
        path: Option<String>, position: Option<i32>, line: Option<i32>, commit_id: String,
    ...
    pub fn builder() -> CommitCommentBuilder {
        CommitCommentBuilder::create_empty()
    }
}
