...
impl DeploymentSimple {
    ...
    pub fn new(
        url: String, id: i32, node_id: String, task: String, environment: String,
        description: Option<String>, created_at: String, updated_at: String, statuses_url: String,
    ...
    pub fn builder() -> DeploymentSimpleBuilder {
        DeploymentSimpleBuilder::create_empty()
    }
}
