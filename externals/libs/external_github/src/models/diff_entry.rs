...
impl DiffEntry {
    /// Diff Entry
    pub fn new(
        sha: String, filename: String, status: Status, additions: i32, deletions: i32,
        changes: i32, blob_url: String, raw_url: String, contents_url: String,
    ) -> DiffEntry {
        DiffEntry {
            sha,
            filename,
