...
impl NullableMilestone {
    ...
    pub fn new(
        url: String, html_url: String, labels_url: String, id: i32, node_id: String, number: i32,
        state: State, title: String, description: Option<String>,
        creator: Option<models::NullableSimpleUser>, open_issues: i32, closed_issues: i32,
        created_at: String, updated_at: String, closed_at: Option<String>, due_on: Option<String>,
    ) -> NullableMilestone {
        NullableMilestone {
            url,
            html_url,
    ...
    pub fn builder() -> NullableMilestoneBuilder {
        NullableMilestoneBuilder::create_empty()
    }
}
/// The state of the milestone.
