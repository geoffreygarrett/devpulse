...
impl BranchWithProtection {
    ...
    pub fn new(
        name: String, commit: models::Commit, _links: models::BranchWithProtectionLinks,
        protected: bool, protection: models::BranchProtection, protection_url: String,
    ...
    pub fn builder() -> BranchWithProtectionBuilder {
        BranchWithProtectionBuilder::create_empty()
    }
}
