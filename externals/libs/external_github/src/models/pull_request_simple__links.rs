...
impl PullRequestSimpleLinks {
    pub fn new(
        comments: models::Link, commits: models::Link, statuses: models::Link, html: models::Link,
        issue: models::Link, review_comments: models::Link, review_comment: models::Link,
    ...
    pub fn builder() -> PullRequestSimpleLinksBuilder {
        PullRequestSimpleLinksBuilder::create_empty()
    }
}
