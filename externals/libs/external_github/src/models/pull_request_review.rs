...
pub struct PullRequestReview {
    ...
    #[serde(rename = "_links")]
    pub _links: Box<models::PullRequestReviewLinks>,
...
impl PullRequestReview {
    ...
    pub fn new(
        id: i32, node_id: String, user: Option<models::NullableSimpleUser>, body: String,
        state: String, html_url: String, pull_request_url: String,
        _links: models::PullRequestReviewLinks, commit_id: Option<String>,
    ...
    pub fn builder() -> PullRequestReviewBuilder {
        PullRequestReviewBuilder::create_empty()
    }
}
