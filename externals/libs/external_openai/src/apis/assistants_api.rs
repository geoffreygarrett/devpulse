...
#[macro_export]
macro_rules! generate_assistants_api_client_methods {
    () => {
        /// cancel_run method
        pub async fn cancel_run(
            &self, params: CancelRunParams,
        ) -> Result<models::RunObject, Error<CancelRunError>> {
            let result = crate::apis::assistants_api::cancel_run(&self.config, params).await?;
            Ok(result)
        }
        ...
        pub async fn create_message(
            ...
            let result = crate::apis::assistants_api::create_message(&self.config, params).await?;
            Ok(result)
        }
        /// create_run method
        pub async fn create_run(
            &self, params: CreateRunParams,
        ) -> Result<models::RunObject, Error<CreateRunError>> {
            let result = crate::apis::assistants_api::create_run(&self.config, params).await?;
            Ok(result)
        }
        /// create_thread method
        pub async fn create_thread(
            &self, params: CreateThreadParams,
        ) -> Result<models::ThreadObject, Error<CreateThreadError>> {
            let result = crate::apis::assistants_api::create_thread(&self.config, params).await?;
            Ok(result)
        }
        /// delete_assistant method
        pub async fn delete_assistant(
            &self, params: DeleteAssistantParams,
        ) -> Result<models::DeleteAssistantResponse, Error<DeleteAssistantError>> {
            let result =
                crate::apis::assistants_api::delete_assistant(&self.config, params).await?;
            Ok(result)
        }
        /// delete_message method
        pub async fn delete_message(
            &self, params: DeleteMessageParams,
        ) -> Result<models::DeleteMessageResponse, Error<DeleteMessageError>> {
            let result = crate::apis::assistants_api::delete_message(&self.config, params).await?;
            Ok(result)
        }
        /// delete_thread method
        pub async fn delete_thread(
            &self, params: DeleteThreadParams,
        ) -> Result<models::DeleteThreadResponse, Error<DeleteThreadError>> {
            let result = crate::apis::assistants_api::delete_thread(&self.config, params).await?;
            Ok(result)
        }
        /// get_assistant method
        pub async fn get_assistant(
            &self, params: GetAssistantParams,
        ) -> Result<models::AssistantObject, Error<GetAssistantError>> {
            let result = crate::apis::assistants_api::get_assistant(&self.config, params).await?;
            Ok(result)
        }
        /// get_message method
        pub async fn get_message(
            &self, params: GetMessageParams,
        ) -> Result<models::MessageObject, Error<GetMessageError>> {
            let result = crate::apis::assistants_api::get_message(&self.config, params).await?;
            Ok(result)
        }
        /// get_run method
        pub async fn get_run(
            &self, params: GetRunParams,
        ) -> Result<models::RunObject, Error<GetRunError>> {
            let result = crate::apis::assistants_api::get_run(&self.config, params).await?;
            Ok(result)
        }
        /// get_run_step method
        pub async fn get_run_step(
            &self, params: GetRunStepParams,
        ) -> Result<models::RunStepObject, Error<GetRunStepError>> {
            let result = crate::apis::assistants_api::get_run_step(&self.config, params).await?;
            Ok(result)
        }
        /// get_thread method
        pub async fn get_thread(
            &self, params: GetThreadParams,
        ) -> Result<models::ThreadObject, Error<GetThreadError>> {
            let result = crate::apis::assistants_api::get_thread(&self.config, params).await?;
            Ok(result)
        }
        /// list_assistants method
        pub async fn list_assistants(
            &self, params: ListAssistantsParams,
        ) -> Result<models::ListAssistantsResponse, Error<ListAssistantsError>> {
            let result = crate::apis::assistants_api::list_assistants(&self.config, params).await?;
            Ok(result)
        }
        ...
        pub async fn list_messages(
            ...
            let result = crate::apis::assistants_api::list_messages(&self.config, params).await?;
            Ok(result)
        }
        /// list_run_steps method
        pub async fn list_run_steps(
            &self, params: ListRunStepsParams,
        ) -> Result<models::ListRunStepsResponse, Error<ListRunStepsError>> {
            let result = crate::apis::assistants_api::list_run_steps(&self.config, params).await?;
            Ok(result)
        }
        /// list_runs method
        pub async fn list_runs(
            &self, params: ListRunsParams,
        ) -> Result<models::ListRunsResponse, Error<ListRunsError>> {
            let result = crate::apis::assistants_api::list_runs(&self.config, params).await?;
            Ok(result)
        }
        /// modify_assistant method
        pub async fn modify_assistant(
            &self, params: ModifyAssistantParams,
        ) -> Result<models::AssistantObject, Error<ModifyAssistantError>> {
            let result =
                crate::apis::assistants_api::modify_assistant(&self.config, params).await?;
            Ok(result)
        }
        /// modify_message method
        pub async fn modify_message(
            &self, params: ModifyMessageParams,
        ) -> Result<models::MessageObject, Error<ModifyMessageError>> {
            let result = crate::apis::assistants_api::modify_message(&self.config, params).await?;
            Ok(result)
        }
        /// modify_run method
        pub async fn modify_run(
            &self, params: ModifyRunParams,
        ) -> Result<models::RunObject, Error<ModifyRunError>> {
            let result = crate::apis::assistants_api::modify_run(&self.config, params).await?;
            Ok(result)
        }
        /// modify_thread method
        pub async fn modify_thread(
            &self, params: ModifyThreadParams,
        ) -> Result<models::ThreadObject, Error<ModifyThreadError>> {
            let result = crate::apis::assistants_api::modify_thread(&self.config, params).await?;
            Ok(result)
        }
        /// submit_tool_ouputs_to_run method
        pub async fn submit_tool_ouputs_to_run(
            &self, params: SubmitToolOuputsToRunParams,
        ) -> Result<models::RunObject, Error<SubmitToolOuputsToRunError>> {
            let result =
                crate::apis::assistants_api::submit_tool_ouputs_to_run(&self.config, params)
                    .await?;
            Ok(result)
        }
    };
...
#[macro_export]
macro_rules! generate_assistants_api_client {
    () => {
        use cached::SizedCache;
        use reqwest::Client;
        use std::sync::Arc;
        ...
        impl<'a> AssistantsApi<'a> {
            ...
            /// create_message method
            pub async fn createmessage(
                &self, params: CreateMessageParams,
            ) -> Result<models::MessageObject, Error<CreateMessageError>> {
                let result =
                    crate::apis::assistants_api::create_message(&self.config, params).await?;
                Ok(result)
            }
            /// create_run method
            pub async fn createrun(
                &self, params: CreateRunParams,
            ) -> Result<models::RunObject, Error<CreateRunError>> {
                let result = crate::apis::assistants_api::create_run(&self.config, params).await?;
                Ok(result)
            ...
            pub async fn createthread(
                ...
                let result =
                    crate::apis::assistants_api::create_thread(&self.config, params).await?;
                Ok(result)
            }
            /// delete_assistant method
            pub async fn deleteassistant(
                &self, params: DeleteAssistantParams,
            ) -> Result<models::DeleteAssistantResponse, Error<DeleteAssistantError>> {
                let result =
                    crate::apis::assistants_api::delete_assistant(&self.config, params).await?;
            ...
            /// delete_message method
            pub async fn deletemessage(
                &self, params: DeleteMessageParams,
            ) -> Result<models::DeleteMessageResponse, Error<DeleteMessageError>> {
                let result =
                    crate::apis::assistants_api::delete_message(&self.config, params).await?;
                Ok(result)
            }
            /// delete_thread method
            pub async fn deletethread(
                &self, params: DeleteThreadParams,
            ) -> Result<models::DeleteThreadResponse, Error<DeleteThreadError>> {
                let result =
                    crate::apis::assistants_api::delete_thread(&self.config, params).await?;
                Ok(result)
            }
            /// get_assistant method
            pub async fn getassistant(
                &self, params: GetAssistantParams,
            ) -> Result<models::AssistantObject, Error<GetAssistantError>> {
                let result =
                    crate::apis::assistants_api::get_assistant(&self.config, params).await?;
                Ok(result)
            }
            /// get_message method
            ...
            /// get_run_step method
            pub async fn getrunstep(
                &self, params: GetRunStepParams,
            ) -> Result<models::RunStepObject, Error<GetRunStepError>> {
                let result =
                    crate::apis::assistants_api::get_run_step(&self.config, params).await?;
                Ok(result)
            }
            /// get_thread method
            pub async fn getthread(
                &self, params: GetThreadParams,
            ) -> Result<models::ThreadObject, Error<GetThreadError>> {
                let result = crate::apis::assistants_api::get_thread(&self.config, params).await?;
                Ok(result)
            ...
            /// list_assistants method
            pub async fn listassistants(
                &self, params: ListAssistantsParams,
            ) -> Result<models::ListAssistantsResponse, Error<ListAssistantsError>> {
                let result =
                    crate::apis::assistants_api::list_assistants(&self.config, params).await?;
                Ok(result)
            }
            /// list_messages method
            pub async fn listmessages(
                ...
                let result =
                    crate::apis::assistants_api::list_messages(&self.config, params).await?;
                Ok(result)
            }
            /// list_run_steps method
            pub async fn listrunsteps(
                &self, params: ListRunStepsParams,
            ) -> Result<models::ListRunStepsResponse, Error<ListRunStepsError>> {
                let result =
                    crate::apis::assistants_api::list_run_steps(&self.config, params).await?;
                Ok(result)
            }
            /// list_runs method
            ...
            /// modify_message method
            pub async fn modifymessage(
                &self, params: ModifyMessageParams,
            ) -> Result<models::MessageObject, Error<ModifyMessageError>> {
                let result =
                    crate::apis::assistants_api::modify_message(&self.config, params).await?;
                Ok(result)
            }
            /// modify_run method
            pub async fn modifyrun(
                &self, params: ModifyRunParams,
            ) -> Result<models::RunObject, Error<ModifyRunError>> {
                let result = crate::apis::assistants_api::modify_run(&self.config, params).await?;
                Ok(result)
            ...
            /// modify_thread method
            pub async fn modifythread(
                &self, params: ModifyThreadParams,
            ) -> Result<models::ThreadObject, Error<ModifyThreadError>> {
                let result =
                    crate::apis::assistants_api::modify_thread(&self.config, params).await?;
                Ok(result)
            }
            /// submit_tool_ouputs_to_run method
            pub async fn submittoolouputstorun(
                &self, params: SubmitToolOuputsToRunParams,
            ) -> Result<models::RunObject, Error<SubmitToolOuputsToRunError>> {
                let result =
                    crate::apis::assistants_api::submit_tool_ouputs_to_run(&self.config, params)
