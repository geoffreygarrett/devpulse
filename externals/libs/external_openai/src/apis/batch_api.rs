...
#[macro_export]
macro_rules! generate_batch_api_client_methods {
    () => {
        /// cancel_batch method
        pub async fn cancel_batch(
            &self, params: CancelBatchParams,
        ) -> Result<models::Batch, Error<CancelBatchError>> {
            let result = crate::apis::batch_api::cancel_batch(&self.config, params).await?;
            Ok(result)
        }
        /// create_batch method
        pub async fn create_batch(
            &self, params: CreateBatchParams,
        ) -> Result<models::Batch, Error<CreateBatchError>> {
            let result = crate::apis::batch_api::create_batch(&self.config, params).await?;
            Ok(result)
        }
        /// list_batches method
        pub async fn list_batches(
            &self, params: ListBatchesParams,
        ) -> Result<models::ListBatchesResponse, Error<ListBatchesError>> {
            let result = crate::apis::batch_api::list_batches(&self.config, params).await?;
            Ok(result)
        }
        /// retrieve_batch method
        pub async fn retrieve_batch(
            &self, params: RetrieveBatchParams,
        ) -> Result<models::Batch, Error<RetrieveBatchError>> {
            let result = crate::apis::batch_api::retrieve_batch(&self.config, params).await?;
            Ok(result)
        }
    };
}
...
#[macro_export]
macro_rules! generate_batch_api_client {
    () => {
        use cached::SizedCache;
        use reqwest::Client;
        use std::sync::Arc;
