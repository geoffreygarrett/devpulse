...
#[macro_export]
macro_rules! generate_vector_stores_api_client_methods {
    () => {
        /// cancel_vector_store_file_batch method
        pub async fn cancel_vector_store_file_batch(
            &self, params: CancelVectorStoreFileBatchParams,
        ) -> Result<models::VectorStoreFileBatchObject, Error<CancelVectorStoreFileBatchError>> {
            let result = crate::apis::vector_stores_api::cancel_vector_store_file_batch(
                &self.config,
                params,
            )
            .await?;
        ...
        pub async fn create_vector_store(
            &self, params: CreateVectorStoreParams,
        ) -> Result<models::VectorStoreObject, Error<CreateVectorStoreError>> {
            let result =
                crate::apis::vector_stores_api::create_vector_store(&self.config, params).await?;
            Ok(result)
        }
        /// create_vector_store_file method
        pub async fn create_vector_store_file(
            &self, params: CreateVectorStoreFileParams,
        ) -> Result<models::VectorStoreFileObject, Error<CreateVectorStoreFileError>> {
            let result =
                crate::apis::vector_stores_api::create_vector_store_file(&self.config, params)
                    .await?;
            Ok(result)
        }
        /// create_vector_store_file_batch method
        pub async fn create_vector_store_file_batch(
            &self, params: CreateVectorStoreFileBatchParams,
        ) -> Result<models::VectorStoreFileBatchObject, Error<CreateVectorStoreFileBatchError>> {
            let result = crate::apis::vector_stores_api::create_vector_store_file_batch(
                &self.config,
                params,
            )
            .await?;
        ...
        /// delete_vector_store method
        pub async fn delete_vector_store(
            &self, params: DeleteVectorStoreParams,
        ) -> Result<models::DeleteVectorStoreResponse, Error<DeleteVectorStoreError>> {
            let result =
                crate::apis::vector_stores_api::delete_vector_store(&self.config, params).await?;
            Ok(result)
        }
        /// delete_vector_store_file method
        pub async fn delete_vector_store_file(
            &self, params: DeleteVectorStoreFileParams,
        ) -> Result<models::DeleteVectorStoreFileResponse, Error<DeleteVectorStoreFileError>> {
            let result =
                crate::apis::vector_stores_api::delete_vector_store_file(&self.config, params)
                    .await?;
            Ok(result)
        }
        /// get_vector_store method
        pub async fn get_vector_store(
            &self, params: GetVectorStoreParams,
        ) -> Result<models::VectorStoreObject, Error<GetVectorStoreError>> {
            let result =
                crate::apis::vector_stores_api::get_vector_store(&self.config, params).await?;
            Ok(result)
        }
        /// get_vector_store_file method
        pub async fn get_vector_store_file(
            &self, params: GetVectorStoreFileParams,
        ) -> Result<models::VectorStoreFileObject, Error<GetVectorStoreFileError>> {
            let result =
                crate::apis::vector_stores_api::get_vector_store_file(&self.config, params).await?;
            Ok(result)
        }
        /// get_vector_store_file_batch method
        pub async fn get_vector_store_file_batch(
            &self, params: GetVectorStoreFileBatchParams,
        ) -> Result<models::VectorStoreFileBatchObject, Error<GetVectorStoreFileBatchError>> {
            let result =
                crate::apis::vector_stores_api::get_vector_store_file_batch(&self.config, params)
                    .await?;
            Ok(result)
        }
        /// list_files_in_vector_store_batch method
        pub async fn list_files_in_vector_store_batch(
            &self, params: ListFilesInVectorStoreBatchParams,
        ) -> Result<models::ListVectorStoreFilesResponse, Error<ListFilesInVectorStoreBatchError>> {
            let result = crate::apis::vector_stores_api::list_files_in_vector_store_batch(
                &self.config,
                params,
            )
            .await?;
        ...
        /// list_vector_store_files method
        pub async fn list_vector_store_files(
            &self, params: ListVectorStoreFilesParams,
        ) -> Result<models::ListVectorStoreFilesResponse, Error<ListVectorStoreFilesError>> {
            let result =
                crate::apis::vector_stores_api::list_vector_store_files(&self.config, params)
                    .await?;
            Ok(result)
        }
        /// list_vector_stores method
        pub async fn list_vector_stores(
            &self, params: ListVectorStoresParams,
        ) -> Result<models::ListVectorStoresResponse, Error<ListVectorStoresError>> {
            let result =
                crate::apis::vector_stores_api::list_vector_stores(&self.config, params).await?;
            Ok(result)
        }
        /// modify_vector_store method
        pub async fn modify_vector_store(
            &self, params: ModifyVectorStoreParams,
        ) -> Result<models::VectorStoreObject, Error<ModifyVectorStoreError>> {
            let result =
                crate::apis::vector_stores_api::modify_vector_store(&self.config, params).await?;
            Ok(result)
        }
    };
}
...
#[macro_export]
macro_rules! generate_vector_stores_api_client {
() => {
    use std::sync::Arc;
    use cached::SizedCache;
    use reqwest::Client;

    pub struct Vector StoresApi<'a> {
        config: &'a Arc<configuration::Configuration>,
        client: Client,
    }

    impl<'a> Vector StoresApi<'a> {
        ...
        /// cancel_vector_store_file_batch method
        pub async  fn cancelvectorstorefilebatch(&self, params: CancelVectorStoreFileBatchParams) ->
            Result<models::VectorStoreFileBatchObject, Error<CancelVectorStoreFileBatchError>> {
            let result = crate::apis::vector_stores_api::cancel_vector_store_file_batch(&self.config, params).await?;
            Ok(result)
        }
        /// create_vector_store method
        pub async  fn createvectorstore(&self, params: CreateVectorStoreParams) ->
            Result<models::VectorStoreObject, Error<CreateVectorStoreError>> {
            let result = crate::apis::vector_stores_api::create_vector_store(&self.config, params).await?;
            Ok(result)
        }
        /// create_vector_store_file method
        pub async  fn createvectorstorefile(&self, params: CreateVectorStoreFileParams) ->
            Result<models::VectorStoreFileObject, Error<CreateVectorStoreFileError>> {
            let result = crate::apis::vector_stores_api::create_vector_store_file(&self.config, params).await?;
            Ok(result)
        }
        /// create_vector_store_file_batch method
        pub async  fn createvectorstorefilebatch(&self, params: CreateVectorStoreFileBatchParams) ->
            Result<models::VectorStoreFileBatchObject, Error<CreateVectorStoreFileBatchError>> {
            let result = crate::apis::vector_stores_api::create_vector_store_file_batch(&self.config, params).await?;
            Ok(result)
        }
        /// delete_vector_store method
        pub async  fn deletevectorstore(&self, params: DeleteVectorStoreParams) ->
            Result<models::DeleteVectorStoreResponse, Error<DeleteVectorStoreError>> {
            let result = crate::apis::vector_stores_api::delete_vector_store(&self.config, params).await?;
            Ok(result)
        }
        /// delete_vector_store_file method
        pub async  fn deletevectorstorefile(&self, params: DeleteVectorStoreFileParams) ->
            Result<models::DeleteVectorStoreFileResponse, Error<DeleteVectorStoreFileError>> {
            let result = crate::apis::vector_stores_api::delete_vector_store_file(&self.config, params).await?;
            Ok(result)
        }
        /// get_vector_store method
        pub async  fn getvectorstore(&self, params: GetVectorStoreParams) ->
            Result<models::VectorStoreObject, Error<GetVectorStoreError>> {
            let result = crate::apis::vector_stores_api::get_vector_store(&self.config, params).await?;
            Ok(result)
        }
        /// get_vector_store_file method
        pub async  fn getvectorstorefile(&self, params: GetVectorStoreFileParams) ->
            Result<models::VectorStoreFileObject, Error<GetVectorStoreFileError>> {
            let result = crate::apis::vector_stores_api::get_vector_store_file(&self.config, params).await?;
            Ok(result)
        }
        /// get_vector_store_file_batch method
        pub async  fn getvectorstorefilebatch(&self, params: GetVectorStoreFileBatchParams) ->
            Result<models::VectorStoreFileBatchObject, Error<GetVectorStoreFileBatchError>> {
            let result = crate::apis::vector_stores_api::get_vector_store_file_batch(&self.config, params).await?;
            Ok(result)
        }
        /// list_files_in_vector_store_batch method
        pub async  fn listfilesinvectorstorebatch(&self, params: ListFilesInVectorStoreBatchParams) ->
            Result<models::ListVectorStoreFilesResponse, Error<ListFilesInVectorStoreBatchError>> {
            let result = crate::apis::vector_stores_api::list_files_in_vector_store_batch(&self.config, params).await?;
            Ok(result)
        }
        /// list_vector_store_files method
        pub async  fn listvectorstorefiles(&self, params: ListVectorStoreFilesParams) ->
            Result<models::ListVectorStoreFilesResponse, Error<ListVectorStoreFilesError>> {
            let result = crate::apis::vector_stores_api::list_vector_store_files(&self.config, params).await?;
            Ok(result)
        }
        /// list_vector_stores method
        pub async  fn listvectorstores(&self, params: ListVectorStoresParams) ->
            Result<models::ListVectorStoresResponse, Error<ListVectorStoresError>> {
            let result = crate::apis::vector_stores_api::list_vector_stores(&self.config, params).await?;
            Ok(result)
        }
        /// modify_vector_store method
        pub async  fn modifyvectorstore(&self, params: ModifyVectorStoreParams) ->
            Result<models::VectorStoreObject, Error<ModifyVectorStoreError>> {
            let result = crate::apis::vector_stores_api::modify_vector_store(&self.config, params).await?;
            Ok(result)
        }
    }
}
