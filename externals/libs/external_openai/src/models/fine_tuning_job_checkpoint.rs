...
impl FineTuningJobCheckpoint {
    ...
    pub fn new(
        id: String, created_at: i32, fine_tuned_model_checkpoint: String, step_number: i32,
        metrics: models::FineTuningJobCheckpointMetrics, fine_tuning_job_id: String,
        object: Object,
    ...
    pub fn builder() -> FineTuningJobCheckpointBuilder {
        FineTuningJobCheckpointBuilder::create_empty()
    }
}
/// The object type, which is always \"fine_tuning.job.checkpoint\".
