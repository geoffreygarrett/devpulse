...
impl CreateAssistantRequestToolResourcesFileSearchVectorStoresInner {
    ...
    pub fn builder() -> CreateAssistantRequestToolResourcesFileSearchVectorStoresInnerBuilder {
        CreateAssistantRequestToolResourcesFileSearchVectorStoresInnerBuilder::create_empty()
    }
}
