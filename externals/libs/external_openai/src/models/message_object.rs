...
impl MessageObject {
    ...
    pub fn new(
        id: String, object: Object, created_at: i32, thread_id: String, status: Status,
        incomplete_details: Option<models::MessageObjectIncompleteDetails>,
        completed_at: Option<i32>, incomplete_at: Option<i32>, role: Role,
        content: Vec<models::MessageObjectContentInner>, assistant_id: Option<String>,
    ...
    pub fn builder() -> MessageObjectBuilder {
        MessageObjectBuilder::create_empty()
    }
}
/// The object type, which is always `thread.message`.
