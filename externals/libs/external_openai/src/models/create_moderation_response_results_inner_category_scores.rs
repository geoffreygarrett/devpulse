...
impl CreateModerationResponseResultsInnerCategoryScores {
    ...
    pub fn new(
        hate: f64, hate_slash_threatening: f64, harassment: f64, harassment_slash_threatening: f64,
        self_harm: f64, self_harm_slash_intent: f64, self_harm_slash_instructions: f64,
        sexual: f64, sexual_slash_minors: f64, violence: f64, violence_slash_graphic: f64,
    ...
    pub fn builder() -> CreateModerationResponseResultsInnerCategoryScoresBuilder {
        CreateModerationResponseResultsInnerCategoryScoresBuilder::create_empty()
    }
}
