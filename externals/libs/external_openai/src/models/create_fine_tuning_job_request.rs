...
pub struct CreateFineTuningJobRequest {
    ...
    /// The ID of an uploaded file that contains training data.  See [upload file](/docs/api-reference/files/create) for how to upload a file.  Your dataset must be formatted as a JSONL file. Additionally, you must upload your file with the purpose `fine-tune`.  The contents of the file should differ depend
...
impl CreateFineTuningJobRequest {
    pub fn new(
        model: models::CreateFineTuningJobRequestModel, training_file: String,
    ...
    pub fn builder() -> CreateFineTuningJobRequestBuilder {
        CreateFineTuningJobRequestBuilder::create_empty()
    }
}
