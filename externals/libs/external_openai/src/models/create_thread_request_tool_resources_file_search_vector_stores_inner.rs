...
pub struct CreateThreadRequestToolResourcesFileSearchVectorStoresInner {
    ...
    pub chunking_strategy: Option<
        Box<models::CreateThreadRequestToolResourcesFileSearchVectorStoresInnerChunkingStrategy>,
    >,
...
impl CreateThreadRequestToolResourcesFileSearchVectorStoresInner {
    ...
    pub fn builder() -> CreateThreadRequestToolResourcesFileSearchVectorStoresInnerBuilder {
        CreateThreadRequestToolResourcesFileSearchVectorStoresInnerBuilder::create_empty()
    }
}
